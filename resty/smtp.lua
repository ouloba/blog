...
send = misc.except(function(mailt)
	...
	print('mailt.domain', mailt.domain, session.greet)
    local ext = session:greet(mailt.domain)
	print('session.auth', mailt.user, mailt.password, ext)
    session:auth(mailt.user, mailt.password, ext)
	print('session.send', mailt.user, mailt.password, ext)
    session:send(mailt)
	print('session.quit', mailt.user, mailt.password, ext)
    session:quit()
